"""rancdev_23419 URL Configuration
...
admin.site.site_header = "rancdev"
admin.site.site_title = "rancdev Admin Portal"
admin.site.index_title = "rancdev Admin"

# swagger
api_info = openapi.Info(
    title="rancdev API",
    default_version="v1",
    description="API documentation for rancdev App",
)
